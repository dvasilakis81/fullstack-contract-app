	...
	getInvoiceInfo() {
		...
		return <>
			...
			<div style={useStyles.divRowFlex}>
				...
				<ProtocolInput tm1={getInvoiceTooltipTemplate(this.state, contractDetails.ConcessionaireName, 1)} tm2={getInvoiceTooltipTemplate(this.state, contractDetails.ConcessionaireName, 2)} title='Α.Π. Τιμολογίου' idn='InvoiceNumber' idd='InvoiceDate' protocolNumber={this.state.InvoiceNumber} protocolDate={this.state.InvoiceDate} onChange={this.onChange} protocolDate={this.state.InvoiceDate} tp1='text' tp2='date' isRequired={true} />

				{/* <MyTextField tp='date' title='Ημ/νία Παραλαβής Τιμολογίου' id='InvoiceDeliveredDate' stateValue={this.state.InvoiceDeliveredDate} isRequired={false} isDisabled={false} onChangeDate={this.onChangeInvoiceDeliveredDate} inputProps={{ style: { textAlign: 'center' } }} isRequired={false} />
				<ProtocolInput title='Α.Π. Ημ/νίας Παραλαβής Τιμολογίου' idn='InvoiceDeliveredDateProtocolNumber' idd='InvoiceDeliveredDateProtocolDate' protocolNumber={this.state.InvoiceDeliveredDateProtocolNumber} protocolDate={this.state.InvoiceDeliveredDateProtocolDate} onChange={this.onChange} onChangeDate={this.onChangeInvoiceDeliveredDateProtocolDate} tp1='text' tp2='date' isRequired={false} />
				<ProtocolInput title='Α.Π. Τιμολογίου' idn='InvoiceNumber' idd='InvoiceDate' protocolNumber={this.state.InvoiceNumber} protocolDate={this.state.InvoiceDate} onChange={this.onChange} onChangeDate={this.onChangeInvoiceDate} protocolDate={this.state.InvoiceDate} tp1='text' tp2='date' isRequired={true} /> */}
			</div>
		</>
	}
