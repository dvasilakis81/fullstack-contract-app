	...
	navigateToEditAccountForm(contractDetails, accountDetails) {
		return <Redirect push to={{
			...
			state: {
				...
				SignType2: accountDetails ? this.getSignatoryTitle(accountDetails.documentsignatory, 2) : '',
				SignType3: accountDetails ? this.getSignatoryTitle(accountDetails.documentsignatory, 3) : '',
				...
				SignName2: accountDetails ? this.getSignatoryName(accountDetails.documentsignatory, 2) : '',
				SignName3: accountDetails ? this.getSignatoryName(accountDetails.documentsignatory, 3) : '',
